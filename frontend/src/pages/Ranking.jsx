...
const Ranking = () => {
  ...
  return (
    <div className="mx-auto max-w-[1000px] rounded-md bg-primary-800 p-4 sm:p-8">
      ...
      <ol className="flex flex-col gap-4 rounded-md text-base">
        {data.entries.map((entry, index) => (
          <li
            key={entry.title}
            className="grid grid-cols-[1fr_3fr_4fr] items-center rounded-md bg-primary-600 
            shadow-md shadow-black sm:grid-cols-[80px_220px_1fr]"
          >
            <p className="justify-self-center text-xl sm:text-3xl">
              {index + 1}
            </p>
